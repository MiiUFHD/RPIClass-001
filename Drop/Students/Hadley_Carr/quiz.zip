...
# >>> int("two")						answer:error
# >>> 	print(str(3+3) + "3")			answer:63
# >>> type(3=3)							answer:syntax error
# >>> "4" == 4							answer:false
# >>> "Python"[4]						answer:'o'
# >>> (3 > 2) or (2 > 3)				answer:true
# >>> not "True"						answer:error
# >>> 2345[2]							answer:error
# >>> str((not True) and (not False))	answer:'false'
# >>> 10 % 3    ans:1
